  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1f1Bnuw8VG55-R_pfg3CNSLwAv5rbBRKU/view?usp=sharing"
            target="_blank"
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
            href="https://www.linkedin.com/in/vladimir-dima-732b78113/"
            target="_blank"
      ...
      >
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, based in Copenhagen, Denmark.
          </p>
        </motion.div>
      </div>
    </motion.section>
